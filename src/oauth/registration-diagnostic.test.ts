...
test("DCR: every explicit 400 branch has a fixed, value-free diagnostic", async (t) => {
  const cases = [
    ...
    { patch: { token_endpoint_auth_method: "private_key_jwt" }, reason: "unsupported_token_endpoint_auth_method", error: "invalid_client_metadata" },
    { patch: { token_endpoint_auth_method: "unknown_method" }, reason: "unsupported_token_endpoint_auth_method", error: "invalid_client_metadata" },
